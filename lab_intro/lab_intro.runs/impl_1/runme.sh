...
HD_PWD='/home/user/Desktop/lab_intro/lab_intro.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_intro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_intro.tcl -notrace
