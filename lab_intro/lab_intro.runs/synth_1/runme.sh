...
HD_PWD='/home/user/Desktop/lab_intro/lab_intro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_intro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_intro.tcl
