...
HD_PWD='/home/user/Desktop/Lab_Synthesis_1/Lab_Synthesis_1/Lab_Synthesis_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_8_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comparator_8_bit.tcl
