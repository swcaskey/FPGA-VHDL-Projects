...
HD_PWD='/home/user/Desktop/Lab_Synthesis_1/Lab_Synthesis_1/Lab_Synthesis_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comparator_8_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comparator_8_bit.tcl -notrace
