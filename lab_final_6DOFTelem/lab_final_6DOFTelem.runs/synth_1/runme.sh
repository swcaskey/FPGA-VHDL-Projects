...
HD_PWD='/home/user/Desktop/lab_final_6DOFTelem/lab_final_6DOFTelem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_telemetry_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_telemetry_top.tcl
