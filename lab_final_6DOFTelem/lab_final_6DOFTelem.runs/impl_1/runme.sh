...
HD_PWD='/home/user/Desktop/lab_final_6DOFTelem/lab_final_6DOFTelem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_telemetry_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_telemetry_top.tcl -notrace
