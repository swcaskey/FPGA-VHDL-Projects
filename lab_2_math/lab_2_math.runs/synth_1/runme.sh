...
HD_PWD='/home/user/Desktop/lab_2_math/lab_2_math.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_tester.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_tester.tcl
