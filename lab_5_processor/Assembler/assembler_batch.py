##---------------------------------------------------------------
# Batch version of assembler - no GUI dialogs
##---------------------------------------------------------------

def assembler(source_file, data_file, text_file):
	...
	print(f"Data COE written to: {data_file}")
	print(f"Text COE written to: {text_file}")
	return True
...
if __name__ == '__main__':
	assembler('hello_world.txt', 'hello_world_data.coe', 'hello_world_text.coe')
