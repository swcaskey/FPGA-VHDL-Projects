...
HD_PWD='/home/user/Desktop/lab_5_processor/lab_5_processor.runs/irMem_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log irMem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source irMem.tcl
