...
HD_PWD='/home/user/Desktop/lab_5_processor/lab_5_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uproc_top_level.tcl
