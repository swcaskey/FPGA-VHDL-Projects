...
HD_PWD='/home/user/Desktop/lab_5_processor/lab_5_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uproc_top_level.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uproc_top_level.tcl -notrace
